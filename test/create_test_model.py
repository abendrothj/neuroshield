...
"""
Create a simple test model for threat detection testing
"""
...
print("Creating test threat detection model...")
...
# Paths
model_dir = '/home/jub/Cursor/neurashield/models/trained/threat_detection_model'
scaler_path = os.path.join(model_dir, 'scaler.pkl')

# Save the model
model.save(model_dir)
print(f'Saved test model to {model_dir}')
